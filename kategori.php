										...
										<tbody>
											<?php $no=1; while($row = mysqli_fetch_assoc($query)){ ?>
												<tr>
													...
													<td>
														<a href="tambah-kategori.php?edit=<?php echo $row['id']; ?>">Edit</a> | <a onclick="return confirm('Apakah anda yakin akan menghapus data ini?')" href="tambah-kategori.php?delete=<?php echo $row['id'] ?>">Hapus</a>
